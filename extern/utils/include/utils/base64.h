...
{
	static_assert(std::is_trivially_copyable<T>::value, "Cannot Base64 encode non trivially copyable types");
...
{
	static_assert(std::is_trivially_copyable<T>::value, "Cannot Base64 decode non trivially copyable types");
